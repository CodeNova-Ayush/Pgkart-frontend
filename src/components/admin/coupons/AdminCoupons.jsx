        ...
        <div style={{ background: 'var(--color-white)', borderRadius: 'var(--radius-large)', padding: 'var(--space-xl)', border: '1.5px solid var(--color-secondary)', marginBottom: 'var(--space-lg)', boxShadow: 'var(--shadow-resting)' }}>
          ...
          <form onSubmit={handleSubmit}>
            <div className="address-grid" style={{ marginBottom: 'var(--space-base)' }}>
              ...
              <div className="form-group">
                <label className="form-label" style={{ color: 'var(--color-midnight)', fontWeight: 500 }}>{form.discountType === 'PERCENTAGE' ? 'Discount Percentage (%) *' : 'Flat Discount Amount (₹) *'}</label>
                <input className="form-control" type="number" name="discountValue" value={form.discountValue}
                  onChange={handleChange} placeholder="0" min={1} style={{ borderRadius: 'var(--radius-small)', borderColor: 'var(--color-secondary)' }} required />
              </div>
              <div className="form-group">
                <label className="form-label" style={{ color: 'var(--color-midnight)', fontWeight: 500 }}>Minimum Order Value (₹) *</label>
                <input className="form-control" type="number" name="minOrderValue" value={form.minOrderValue || ''}
                  onChange={handleChange} placeholder="e.g. 500" min={0} style={{ borderRadius: 'var(--radius-small)', borderColor: 'var(--color-secondary)' }} required />
              </div>
